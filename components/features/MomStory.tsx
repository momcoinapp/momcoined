            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto space-y-16">
                    ...
                    <div className="text-center space-y-4">
                        <div className="bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 rounded-full px-6 py-2 inline-block mb-4">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-200 to-purple-200 font-bold uppercase tracking-widest text-xs">
                                Verified Real Mom & Son Team ✅
                            </span>
                        </div>
                        <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="space-y-6 text-lg text-purple-100 leading-relaxed font-medium">
                                ...
                                <p>
                                    She is the real deal. A mother, a crypto degen, and now on a mission to bring trust and social good back onchain—using social media and financial tools to influence positivity for the next billion users.
                                </p>
                            </div>
